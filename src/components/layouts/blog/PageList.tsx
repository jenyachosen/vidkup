...
const BlogPageList: FunctionComponent<Props> = (props) => {
  const { contents, locale, total, pageCurrent = 1 } = props;
  ...
  return (
    <Fragment>
      <Navbar localeChange onLocaleChange={handleLocaleChange} />
      <Banner
      ...
      <Content className="flex flex-col items-center justify-center">
        <BlogCardList className="-mt-80" contents={contents} locale={locale} />
        {pageCount > 1 && (
