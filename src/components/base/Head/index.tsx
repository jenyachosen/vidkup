...
const Head: FunctionComponent<PropsWithChildren<Props>> = (props) => {
  ...
  const {
    title,
    slug,
    description = 'Redemption church in Mukachevo, Transkarpatia, Ukraine 🇺🇦',
  ...
  const combinedKeywords = useMemo(() => {
    return (
      [...tags, keywords].join(', ') +
      'vidkup, redemption, mukachevo church, церква мукачево, відкуплення, церква відкуплення'
    );
  }, [tags, keywords]);
  ...
  return (
    <NextHead>
      ...
      <meta
        name="language"
        content={language?.[locale as I18nLocales] || language[DEFAULT_LOCALE]}
      />
      ...
      <meta
        ...
        content="eGOhdZjNeSLIBtMneyjMwoE3fg4c4-v4okvoqNf4ZlQ"
      />
